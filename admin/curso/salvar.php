<?php require('../../conexao.php');
	...
	if (isset($_POST['codigo_hotel'])) {
		...
		$update_curso2 = "UPDATE curso2 SET nome_hotel, endereco_hotel, contato_hotel, email_hotel =   '".$nome_hotel."', '".$endereco_hotel."', '".$contato_hotel."', '".$email_hotel."'  WHERE codigo_hotel = $codigo_hotel";
